...
@section('title','Cambridge School | Payment Arrears Report')
...
@section('content')
    @include('auth.logout')
    @include('Activities.Reports.paymentArrearsRptFrm')
...
@section('script')
    ...
    <script src="{{asset('/js/fillPayArrearsRpt.js')}}" type="text/javascript"></script>
    <script>
