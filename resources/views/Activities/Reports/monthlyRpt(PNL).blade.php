...
@section('title','Cambridge School | Monthly Report')
...
@section('content')
    @include('auth.logout')
    @include('Activities.Reports.monthlyRpt(PNL)Frm')
...
@section('script')
    ...
    <script src="{{asset('/js/fillMonthlyRpt.js')}}" type="text/javascript"></script>
    <script>
