        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                $.each(data, function (index, value) {
                    ...
                    var y = '<tr>' + '<td>' + value.admmision_no + '</td>' + '<td>' + value.NAME + '</td>' + '<td>' + value.class_category + '</td>' + '<td>' + value.amount + '</td>' + '<td>' + value.totTermfee + '</td>' + '<td>' + (value.totTermfee - value.amount) + '</td>' + '<td>' + value.yrs + '</td>' + '</tr>';
