...
@section('title','Cambridge School | Daily Transaction Report')
...
@section('content')
    @include('auth.logout')
    @include('Activities.Reports.dailyTransactionRptFrm')
...
@section('script')
    ...
    <script src="{{asset('/js/filldailyTReport.js')}}" type="text/javascript"></script>
    <script>
